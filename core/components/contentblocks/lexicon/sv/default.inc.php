...
$_lang['contentblocks.image_template.description'] = "Mall för inmatningstypen bild. Bör troligen innehålla en <code>&lt;img&gt;</code> tagg. Tillgänglig platshållare: <code>[[+url]]</code>, <code>[[+size]]</code>, <code>[[+extension]]</code>";
...
$_lang['contentblocks.image_with_title_template.description'] = "Mall för inmatningstypen bild. Bör troligen innehålla en <code>&lt;img&gt;</code> tagg. Tillgängliga platshållare: <code>[[+url]]</code> och <code>[[+title]]</code>, <code>[[+size]]</code>, <code>[[+extension]]</code>";
...
$_lang['contentblocks.repeater.wrapper_template.description'] = "Yttre mall att omsluta alla andra behandlade rader med. Bör innehålla platshållaren <code>[[+rows]]</code>.";
