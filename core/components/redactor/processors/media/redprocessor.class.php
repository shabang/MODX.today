...
abstract class redProcessor extends modProcessor {
    ...
    public function getSource() {
        ...
        $mediaSourceId = $this->modx->getOption('redactor.mediasource', null, $this->modx->getOption('default_media_source', null, 1), true);
    ...
    public function sanitizeFileName($fname) {
        $replace=$this->modx->getOption('redactor.sanitizeReplace', null, '_');
        $pattern=$this->modx->getOption('redactor.sanitizePattern', null, "/([[:alnum:]_\.-]*)/");
    ...
    public function outputArray(array $array,$count = false) {
        return $this->modx->toJSON((count($array) > 1) ? $array : $array[0] );
    }
}
return 'redProcessor';
