...
class RedactorFileBrowserProcessor extends redProcessor {
    ...
    public function initialize() {
        $this->browseRecursive   = (bool)$this->modx->getOption('redactor.browse_recursive', null, true);
        $vd = $this->modx->getVersionData();
        $this->patch_11291 = (bool)((bool)$this->modx->getOption('redactor.patch_11291', null, true) && version_compare('2.2.15-pl',$vd['full_version'],'<='));
    ...
    public function process() {
        ...
        $path = $this->modx->getOption('redactor.'.$this->browsePath,null,$this->modx->getOption('redactor.'.$this->uploadPath,null,'assets/uploads/'));
        if ($this->tv) {
