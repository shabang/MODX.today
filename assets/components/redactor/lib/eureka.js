		...
		return {
			...
			load: function() {
                ...
                this.eureka.doEureka(' an Image', { // init the Eureka component
                    ...
                    storagePrefix:'redactor-media-browser_0_' + that.opts._name,
                    ...
                    that.image.insert({filelink:e.detail.src});
                    that.image.onDrop();
            ...
            loadFile: function(){
                ...
                this.eureka.doEureka(' a File', { // init the Eureka component
                    ...
                    webWorkersPath: that.opts.assetsUrl + 'lib/eureka/js/workers/',
                    useLocalStorage:true,
                    storagePrefix:'redactor-file-browser_0_' + that.opts._name,
                    sortMediaSources:true,
                    currentDirectory: undefined,
                    confirmBeforeDelete: false,
                    allowRename:false,
